...
function DashBoard() {
    ...
    return (
        <div className="main-dashboard-container bg-zinc-900 ">
            <div className="main-dashboard-hello h-60 flex flex-col items-start justify-start">
                <h5 className="text-zinc-500 font-light text-[1.2rem]">welcome back, {name} 👋</h5> 
                <div className="flex items-end justify-between w-full">
                <h1 className="font-rejouice text-zinc-400 translate-y-[-25%]">DashBoard</h1>
                <h4 className="text-zinc-500 font-thin text-[1.2rem] mb-10 ">{currentDate}</h4> 
                </div>        
            </div>
