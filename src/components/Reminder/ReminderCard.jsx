    ...
    return (
        <div className="reminder-card-main">
            <div className="reminder-card">
                <div className="remainder-card-sub text-zinc-100">
                    <h3 className="">{reminderName}</h3>
                    <p className="text-zinc-300">{formatDate(date)}</p>
                    <h4 className="text-zinc-500">{repeatType}</h4>
                </div>
                <div className="reminder-card-icons">
                    <h2 className="reminder-card-price text-zinc-100">{price}</h2>
                    <MdDelete
